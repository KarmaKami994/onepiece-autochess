...
P4C Complete Item Integration and its bounded PR #47 review correction are implemented on `feat/p4c-complete-item-integration` from exact base `e88ed002cc27fcfe1a05909cba6b6e45cece8e67`. All 55 completed recipes now have their approved identity; normal rewards use the ten components, deterministic merge backfill, recipe-aware legal bot equipping and accessible semantic item details complete the production loop. P4 is COMPLETE. GameContent is `1.23.0`; schema remains 6. Final authored item art remains deferred until after P6.

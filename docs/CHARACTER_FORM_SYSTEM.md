...
shop/pool identity, star or items. Production content currently defines no
forms.
...
snapshots. Old schema-6 saves and legacy battle snapshots without a form ID
remain base-form compatible. Unknown IDs are preserved but resolve safely to
base behavior.

## Explicitly Not Built Yet

This foundation adds no triggers, runtime transformations, form commands, form
UI, form VFX, form assets or playable pilot forms.

## Planned Pilots

- Robin can later receive persistent form identity from star progression.
...
Transition rules, branch selection, combat timing/synergy rules, transform
events and form-specific presentation remain separate future work.
